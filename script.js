const createBlogCard = (title, date, description,idx) => {
  return `
        <div class="card col" style="font-size: 12px; border: none;"> 
            ...
            <button style="width:100px; border:none; background:none; padding:0px;" index="${idx}" id="read-more" href="./blogg.html" class="text-primary" href="" style="text-decoration: none;">Read More</button>
